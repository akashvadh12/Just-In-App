...
class HomeController extends GetxController {
  ...
  // Replace the existing _updateTrackingState() method:
  ...
  // Simplified _startTracking() method:
  void _startTracking() {
  ...
  // Simplified _stopTracking() method:
  void _stopTracking() {
    liveTrackingService.stopTracking();
  ...
  bool _shouldStartTracking(UserModel? userModel) {
    ...
    final isClockedIn =
        attendanceStatus.value == 'In' || userModel.clockStatus == true;
