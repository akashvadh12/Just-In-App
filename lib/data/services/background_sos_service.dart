...
class BackgroundSosService {
  ...
  static const String _sosNotificationChannelName = "SOS Check-in Notifications";
  ...
  static Future<void> startBackgroundService({
    ...
    await prefs.setInt('sos_last_checkin', DateTime.now().millisecondsSinceEpoch);
    ...
    print('✅ Background SOS service started with ${intervalMinutes}min interval');
  }
  ...
  static void _onNotificationTapped(NotificationResponse response) {
    print('🔔 SOS Notification tapped: ${response.payload}');
    ...
    if (response.payload != null) {
      ...
      if (type == 'sos_checkin') {
        // Send port message to main isolate to show dialog
        _sendPortMessage({
  ...
  static void _sendPortMessage(Map<String, dynamic> message) {
    final SendPort? sendPort = IsolateNameServer.lookupPortByName('sos_main_port');
  ...
  static Future<void> _handleNotificationAction(String action, String payload) async {
    ...
    try {
      ...
      await _sendCheckInResponse(responseType, userId, checkInId, promptTime, companyId, siteId);
      await _cancelAllNotifications();
  ...
  static Future<void> _sendSosAlert(String userId, String checkInId) async {
    ...
    await _sendCheckInResponse('SOS', userId, checkInId, promptTime, companyId, siteId);
  }
...
// Schedule timeout check
void _scheduleTimeoutCheck(String checkInId, int responseMinutes, String promptTime) {
